...
public class BigRationalTests
{
    ...
    {
        Assert.Equal(new BigRational(5, 1), BigRational.Parse("5", CultureInfo.InvariantCulture));
        Assert.Equal(new BigRational(7, 8), BigRational.Parse(" 7/8 ", CultureInfo.InvariantCulture));
    }
    ...
    public void Decimal_Overflow_Throws()
    {
        ...
        var big = new BigRational(BigInteger.Parse("1000000000000000000000000000000000", CultureInfo.InvariantCulture), BigInteger.One);
